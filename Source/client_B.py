...
MY_IP = "127.0.0.1"
MY_PORT = 15000      # port de réception de B

TARGET_IP = "127.0.0.1"
TARGET_PORT = 14000  # port de A
...
class ClientBWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Client B - Onion Routing")
        self.resize(700, 500)
        ...
        hl = QHBoxLayout()
        hl.addWidget(QLabel("Message pour A :"))
        ...
        self.send_btn = QPushButton("Envoyer à A")
        ...
        t.start()
        self.log("Client B démarré, écoute sur %s:%d" % (MY_IP, MY_PORT))
    ...
    def send_message(self):
        ...
        self.log(f"[INFO] Route B → A ({hops} sauts) : {route_str}")
        ...
        try:
            ...
            self.log("[SEND] Oignon envoyé à A via " +
